...
namespace Arcade {
	...
	private:
		...
		void printGhost(Arcade::IGraphicLib &, Arcade::Vect<size_t>) const;
		void printPac(Arcade::IGraphicLib &, Arcade::Vect<size_t>) const;
		void printMaze(Arcade::IGraphicLib &, Arcade::Vect<size_t>) const;
